...
class XDT 
{
	...
	public final function load (string $xml, ?bool $preserve_white_space = false, ?bool $format_output = false) : bool
	{
		$xml = \tidy_repair_string($xml, $config = [
			...
			'output-html'    => false,      
			'wrap'           => 200,        // Cuts lines at 200 characters (enter 0 to avoid cutting)
			'tidy-mark'      => false,      // Do not add the comment "Generated by Tidy"
			'show-body-only' => false,      // If true, only display what is in <body> (useful for fragments)
		]);
